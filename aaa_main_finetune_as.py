...
def main(args):
    ...
    ### savepath fron args.resume
    saved_path = args.resume
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # if epoch == 1:
            ...
            if dist.get_rank() == 0:
                ...
                with open(f'{final_policy_path.split(".")[0]}_cnt={cnt}.{final_policy_path.split(".")[1]}', 'w') as write_f:
