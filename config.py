...
_C.DATA.LENGTH = 1024
# dataset means
_C.DATA.MEAN = -4.2677393
# dataset std
_C.DATA.STD = 4.5689974
# train json file path
_C.DATA.TRAIN_JSON = "/root/youkang/MAE/unbalanced_train.json"
# eval json file path
_C.DATA.EVAL_JSON = "/root/youkang/MAE/eval.json"
# label csv
_C.DATA.LABEL_CSV = "/root/youkang/SimMIM/data/class_labels_indices.csv"
...
# main_metrics = 'acc'
_C.TRAIN.METRICS = 'mAP'
_C.TRAIN.LOSS = 'BCE'
_C.TRAIN.FROZZEZ = False
_C.TRAIN.SIMMIM = False
...
# How to apply mixup/cutmix partams. Per "batch", "pair", or "elem"
...
def update_config(config, args):
    ...
    ### add aug
    if _check_args('final_policy'):
        config.final_policy=args.final_policy
